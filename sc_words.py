# Shakespeare play classification -- lines
...
# 	"Merry Wives of Winsor":[merry_wives, 1], "Henry V":[henry_v, 2], "Richard II":[richard_iii, 2],
# 	"Henry IV part 1":[henry_iv_1, 2], "Henry IV part 2":[henry_iv_2, 2], "Henry VI part 1":[henry_vi_1, 2],
# 	"Henry VI part 2":[henry_vi_2, 2], "Henry VI part 3":[henry_vi_3, 2], "Timon of Athens":[timon, 0],
# 	"Antony and Cleopatra":[a_and_c, 0], "Two Gentlemen of Verona":[two_gentlemen, 1], "The Tempest":[tempest, 1],
# 	"Pericles":[pericles, 1], "Merchant of Venice":[merchant, 1], "Measure for Measure":[measure, 1],
# 	"Taming of the Shrew":[shrew, 1], "Winter's Tale":[winters_tale, 1], 
# 	"Richard II":[richard_ii, 2], "King John":[john, 2], "Henry VIII":[henry_viii, 2]}

# "Troilus and Cressida":[t_and_c, 1], "Cymbeline":[cymbeline, 1],
